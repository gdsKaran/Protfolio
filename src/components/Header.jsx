...
import avatarImage from '@/images/fav.jpg'
...
function MobileNavigation() {
  ...
  return (
    <Link href={path ? '/projects' : '/'}>
      <button className="group pointer-events-auto flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm md:hidden dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20">
        {path ? 'Projects' : 'About'}
      </button>
    </Link>
  )

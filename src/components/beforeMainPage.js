      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Full Stack Developer skilled in Next.js, JavaScript, Tailwind CSS,
            Node.js, PostgreSQL, and MongoDB, specializing in building
            high-performance and visually stunning web applications. Ability to
            translate tinkering ideas into technical solutions, with strong
